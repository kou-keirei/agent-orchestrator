...
var schemaNames = map[string]string{ //nolint:gosec // Public OpenAPI type names include reset-credit contracts; no credential value is stored here.
	...
	"ControllersNativePermissionEvidence":                  "NativePermissionEvidence",
	"ControllersChatDispatchConformance":                   "ChatDispatchConformance",
	"ControllersChatDispatchEvidence":                      "ChatDispatchEvidence",
	"ControllersChatDispatchVariant":                       "ChatDispatchVariant",
	...
	"ControllersSetConversationTurnSettingsRequest":        "SetConversationTurnSettingsRequest",
...
func shellTerminalOperations() []operation {
	return []operation{
		...
		},
		{
			...
			pathParams: []any{controllers.SessionIDParam{}},
			reqBody:    controllers.SetConversationTurnSettingsRequest{},
			resps: []respUnit{
